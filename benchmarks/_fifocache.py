...
class CachetoolsFIFOCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachetools.FIFOCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachetools.FIFOCache(self.maxsize)
...
class CacheboxFIFOCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachebox.FIFOCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachebox.FIFOCache(self.maxsize)
        cache.update({i:i for i in range(self.maxsize)})
        return cache
