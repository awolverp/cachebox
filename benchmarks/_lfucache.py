...
class CachetoolsLFUCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachetools.LFUCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachetools.LFUCache(self.maxsize)
...
class CacheboxLFUCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachebox.LFUCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachebox.LFUCache(self.maxsize)
        cache.update({i:i for i in range(self.maxsize)})
        return cache
