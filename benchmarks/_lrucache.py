...
class CachetoolsLRUCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachetools.LRUCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachetools.LRUCache(self.maxsize)
...
class CacheboxLRUCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachebox.LRUCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachebox.LRUCache(self.maxsize)
        cache.update({i:i for i in range(self.maxsize)})
        return cache
