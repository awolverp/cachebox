...
class CachetoolsRRCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachetools.RRCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachetools.RRCache(self.maxsize)
...
class CacheboxRRCache(Bench):
    maxsize = 1000
    rangesize = 10000

    def insert_setUp(self):
        return cachebox.RRCache(self.maxsize)
    ...
    def delete_setUp(self):
        cache = cachebox.RRCache(self.maxsize)
        cache.update({i:i for i in range(self.maxsize)})
        return cache
